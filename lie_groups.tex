...
\begin{definition}[חבורה אלגברית ממשית]
תהי
...
\begin{definition}[חבורה רדוקטיבית]
תהי
$G \leq \mrm{GL}_n\prs{\mbb{C}}$.
נגדיר כי
$G$
...
\begin{definition}[אלגברת לי רדוקטיבית]
אלגברת לי
$\mfrak{g}$
תיקרא
\emph{רדוקטיבית}
...
\begin{definition}[אלגברת לי פשוטה]
אלגברת לי
$\mfrak{g}$
תיקרא
\emph{פשוטה}
...
\begin{definition}[אלגברת לי פשוטה למחצה]
אלגברת לי
$\mfrak{g}$
נקראת
\emph{פשוטה למחצה}
...
עבור אלגברת לי
$\mfrak{g}$
נגדיר תבנית בילינארית סימטרית
\begin{align*}
B_{\mfrak{g}} \colon \mfrak{g} \times \mfrak{g} &\to \mbb{F} \\
\text{.}\prs{X,Y} &\mapsto \tr\prs{\ad\prs{X} \ad\prs{Y}}
\end{align*}
\end{definition}
...
מתקיים
\begin{align*}
B_{\mfrak{g}}\prs{\brs{Z,X}, Y} &= \tr\prs{\brs{\ad\prs{Z}, \ad\prs{X}} \ad\prs{Y}}
\\&= B_{\mfrak{g}}\prs{X, \brs{Y,Z}}
\end{align*}
ובפרט
\[\text{.}\mrm{rad}\prs{\mfrak{g}} \ceq \set{X \in \mfrak{g}}{B_{\mfrak{g}\prs{X,\mfrak{g}} = 0}} \ideal \mfrak{g}\]
\end{remark}

\begin{theorem}[קריטריון
\textenglish{Cartan}]
$\mfrak{g}$
פשוטה למחצה אם ורק אם
$\mrm{rad}\prs{\mfrak{g}} = \set{0}$,
כלומר אם ורק אם
$B_{\mfrak{g}}$
לא־מנוונת.
\end{theorem}
...
אם
$B_{\mfrak{g}}$
היא תבנית לא־מנוונת נוכיח ש־%
$\mfrak{g}$
רדוקטיבית באותה טכניקה כמו בהוכחות הקודמות, עם שימוש בתבנית
$B_{\mfrak{g}}$.
מכך ש־%
$Z\prs{\mfrak{g}} \leq \mrm{rad}\prs{\mfrak{g}}$
נובע
$Z\prs{g} = \set{0}$.

בכיוון ההפוך מספיק להוכיח עבור
$\mfrak{g}$
פשוטה שמתקיים
$\mrm{rad}\prs{\mfrak{g}} \in \set{0, \mfrak{g}}$
כלומר ש־%
$B_{\mfrak{g}} \neq 0$,
מה שלא נעשה.
\end{proof}

נזכיר כי עבור אלגברת לי
$\mfrak{g}$
מתקיים
$\ad\prs{\mfrak{g}} \leq \endo\prs{\mfrak{g}}$.
נסמן
\[G_{\ad}\prs{\mfrak{g}} \ceq \Gamma\prs{\ad\prs{\mfrak{g}}} \leq \mrm{GL}\prs{\mfrak{g}}\]
ואז
$\Lie\prs{G_{\ad}\prs{\mfrak{g}}} = \ad\prs{\mfrak{g}}$.
ראינו שלכל
$G$
קשירה כך שמתקיים
$\Lie\prs{G} = \mfrak{g}$
מתקיים גם
\[\text{.} \quot{G}{Z\prs{G}} \cong G_{\ad}\prs{\mfrak{g}}\]
אז מתקיים
\[\text{.} G_{\ad}\prs{\mfrak{g}} = \Ad_{\mfrak{g}}\prs{G}\]

\begin{definition}[הומומורפיזם של אלגבראות לי]
תהיינה
$\mfrak{g}, \mfrak{h}$
אלגבראות לי.
